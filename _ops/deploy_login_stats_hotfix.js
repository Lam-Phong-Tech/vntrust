// Hotfix: dashboard stats SQLite limit + login auto-fill demo creds
...
const FILES = [
  'src/app/api/dashboard/stats/route.ts',     // fix SQLite param limit
  'src/app/api/auth/demo-creds/route.ts',     // new: serve demo creds from env
  'src/app/login/[role]/page.tsx',            // fetch demo creds + auto-fill
];
...
async function main() {
  ...
  const backupDir = `${REMOTE_ROOT}/_backups/login_stats.${stamp}`;
