...
const FILES = [
  // D2: mTLS HMAC auth
  'src/lib/mtlsAuth.ts',
  // D1: 4 service modules
  'src/services/reportIngestion.ts',
  'src/services/identityService.ts',
  'src/services/anonymizationService.ts',
  'src/services/apiGateway.ts',
  // D1: microservices pipeline endpoint
  'src/app/api/microservices/pipeline/route.ts',
  // D3: tokenization vault
  'src/app/api/vault/tokenization/route.ts',
  // D4: DTIA + microservices section in legal page
  'src/app/dashboard/compliance/legal/page.tsx',
];
...
async function main() {
  ...
  const backupDir = `${REMOTE_ROOT}/_backups/sprint6.${stamp}`;
