// Hotfix: verify result page đọc hinhAnhUrl (field upload) thay vì hinhAnh (legacy)
...
const FILES = ['src/app/verify/[uid]/page.tsx'];
...
async function main() {
  ...
  const backupDir = `${REMOTE_ROOT}/_backups/fix_img.${stamp}`;
