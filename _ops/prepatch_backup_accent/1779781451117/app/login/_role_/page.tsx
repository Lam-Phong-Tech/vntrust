    ...
    <div style={{ position:'fixed', inset:0, background:'#0B1623', display:'flex', flexDirection:'column', alignItems:'center', zIndex:100, overflowY:'auto' }}>
      ...
      <div style={{ position:'relative', zIndex:1, width:'100%', maxWidth:440, margin:'auto', padding:'32px 20px 40px' }}>
        ...
        <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:28 }}>
          ...
          <div style={{ width:40, height:40, borderRadius:10, background:'rgba(200, 165, 87, 0.1)', border:'1px solid rgba(200, 165, 87, 0.2)', display:'flex', alignItems:'center', justifyContent:'center', color:'#C8A557', flexShrink:0 }}>
            <div style={{ width: 18, height: 18 }}>
              {roleIconsSvg[pageRole] || <span className="material-symbols-outlined" style={{ fontSize:18 }}>shield</span>}
            </div>
          </div>
        </div>
              ...
              <form onSubmit={handleAction} className="space-y-4">
                ...
                <div>
                  <label className="block text-xs font-bold text-slate-400 uppercase tracking-widest mb-1.5">
                    ...
                    <span className="ml-2 text-[10px] font-normal text-slate-500 normal-case">(≥12 ký tự)</span>
                  </label>
                  <div className="relative">
