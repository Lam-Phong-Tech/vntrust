        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            {[
              ...
              { label: t("ana_open_alerts"),    value: overview.openAlerts,   icon: "notifications_active", color: overview.openAlerts > 0 ? "text-[#C8A557]" : "text-emerald-400", cls: overview.openAlerts > 0 ? "border-[#C8A557]/20 bg-amber-900/10" : "border-white/10" },
              { label: t("ana_expiring_soon"),  value: overview.expiringSoon, icon: "event_busy",           color: overview.expiringSoon > 0 ? "text-[#C8A557]" : "text-emerald-400", cls: overview.expiringSoon > 0 ? "border-[#C8A557]/20 bg-amber-900/10" : "border-white/10" },
            ].map((s, i) => (
