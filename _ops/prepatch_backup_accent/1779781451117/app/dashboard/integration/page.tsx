  ...
  return (
    <div className="min-h-[calc(100vh-80px)] p-6 md:p-10 max-w-7xl mx-auto">
      ...
      <div className="mb-8">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-black text-white font-display">{t("int_title")}</h1>
      ...
      <div className="glass-panel border border-cyan-500/20 rounded-2xl p-6">
        ...
        {/* Query Result */}
        {queryResult && (
          <div className={`mt-5 p-4 rounded-xl border ${queryResult.result.status === "valid" ? "bg-emerald-500/10 border-emerald-500/30" : queryResult.result.status === "not_found" ? "bg-[#C8A557]/10 border-[#C8A557]/20" : "bg-red-500/10 border-red-500/20"}`}>
            <div className="flex items-center gap-3 mb-3">
              <span className={`material-symbols-outlined text-2xl ${queryResult.result.status === "valid" ? "text-emerald-400" : queryResult.result.status === "not_found" ? "text-[#C8A557]" : "text-red-400"}`}>
