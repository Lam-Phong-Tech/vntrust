      ...
      <div className="space-y-3 mb-5">
        {[{ name: "Nguyễn Văn An", role: "Chuyên gia chống giả cấp cao", status: "online" }, { name: "Trần Thị Bình", role: "Phân tích chuỗi cung ứng", status: "online" }, { name: "Lê Minh Cường", role: "Kỹ thuật xác thực AI", status: "busy" }].map((ex, i) => (
          <div key={i} className="flex items-center gap-3 p-3 bg-white/5 rounded-xl border border-white/10 hover:bg-white/10 transition cursor-pointer">
            ...
            <span className={`w-2.5 h-2.5 rounded-full ${ex.status === "online" ? "bg-emerald-400" : "bg-[#C8A557]"}`}></span>
          </div>
        ))}
      </div>
...
function MapDetailModal({ marker, onClose }: { marker: MapMarker; onClose: () => void }) {
  ...
  const typeColor = marker.type === "hot" ? "text-[#C8A557]" : marker.type === "warning" ? "text-orange-400" : "text-emerald-400";
  const typeBg = marker.type === "hot" ? "bg-[#C8A557]/10 border-[#C8A557]/30" : marker.type === "warning" ? "bg-orange-500/10 border-orange-500/30" : "bg-emerald-500/10 border-emerald-500/30";
  return (
    <ModalWrapper onClose={onClose} title={marker.name} icon="language" iconColor={marker.type === 'hot' ? 'bg-[#C8A557]' : marker.type === 'warning' ? 'bg-orange-500' : 'bg-emerald-500'}>
      ...
      <div className="grid grid-cols-3 gap-3 mb-5">
        ...
        <div className="bg-white/5 rounded-2xl p-4 text-center border border-white/10">
          <p className={`text-xl font-black ${marker.fake > 0 ? "text-[#C8A557]" : "text-emerald-400"}`}>{marker.fake}</p>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-12 gap-8 lg:gap-12 relative z-10 w-full h-full flex-1">
          ...
          <div className="xl:col-span-6 flex flex-col gap-6">
              ...
              <div className="xl:hidden flex flex-col gap-5 mt-2 mb-4 animate-fade-in">
                 ...
                 <div className="relative rounded-[2rem] p-6 border border-[#C8A557]/30 overflow-hidden shadow-xl" style={{ background: 'linear-gradient(145deg, rgba(200,165,87,0.15) 0%, rgba(200,165,87,0.02) 100%)' }}>
                   <div className="relative z-10 flex justify-between items-start mb-8">
                     <div>
                       ...
                       <div className="text-5xl font-black text-white font-display">7,842<span className="text-base text-slate-400 font-normal ml-1 tracking-normal">lần</span></div>
                     </div>
                 ...
                 <div className="grid grid-cols-2 gap-4">
                   ...
                   <div className="glass-card rounded-3xl p-5 border border-[#C8A557]/20 flex flex-col justify-between">
                     ...
                     <div>
                       ...
                       <div className="text-[10px] text-[#C8A557] font-bold">2 cao · 6 TB</div>
                     </div>
                   </div>
                 ...
                 <div className="mt-4">
                    <div className="flex justify-between items-center mb-4 px-1">
                       ...
                       <Link href="/dashboard/history" className="text-[11px] font-bold text-[#C8A557] flex items-center hover:underline">
                    ...
                    <div className="space-y-3">
                       ...
                       <div className="glass-panel p-4 rounded-[1.25rem] flex items-center gap-4 border-l-4 border-l-amber-500 bg-white/5">
                         <div className="w-10 h-10 rounded-full bg-[#C8A557]/20 flex items-center justify-center shrink-0">
                           <span className="material-symbols-outlined text-[#C8A557] text-[20px]">location_off</span>
                         </div>
                         <div className="flex-1 min-w-0">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
              ...
              {(userRole === 'admin') && (
                <Link href="/dashboard/kyc" className="glass-card rounded-3xl p-5 flex flex-col justify-between h-40 group relative overflow-hidden border border-cyan-500/20">
              ...
              {(userRole === 'admin' || userRole === 'manufacturer' || userRole === 'importer') && (
                <Link href="/dashboard/distribution" className="glass-card rounded-3xl p-5 flex flex-col justify-between h-40 group relative overflow-hidden border border-purple-500/20">
                  <div className="absolute inset-0 bg-gradient-to-br from-purple-400/15 to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />
                  <div className="flex items-start justify-between mb-2">
              ...
              {userRole === 'admin' && (
                <Link href="/dashboard/security" className="glass-card rounded-3xl p-5 flex flex-col justify-between h-40 group relative overflow-hidden border border-violet-500/20">
                  <div className="absolute inset-0 bg-gradient-to-br from-violet-400/15 to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />
                  <div className="flex items-start justify-between mb-2">
                    <span className="material-symbols-outlined text-3xl text-violet-400">security</span>
                    <span className="text-[9px] font-bold px-1.5 py-0.5 bg-violet-500/20 text-violet-300 rounded-full border border-violet-500/30">NFR-SC</span>
                  </div>
              ...
              {(userRole === 'admin' || userRole === 'manufacturer' || userRole === 'importer') && (
                <Link href="/dashboard/compliance" className="glass-card rounded-3xl p-5 flex flex-col justify-between h-40 group relative overflow-hidden border border-emerald-500/20">
              ...
              {userRole === 'admin' && (
                <Link href="/dashboard/roadmap" className="glass-card rounded-3xl p-5 flex flex-col justify-between h-32 group relative overflow-hidden border border-purple-500/20">
                  ...
                  <span className="material-symbols-outlined text-4xl text-purple-400">map</span>
              ...
              {userRole === 'admin' && (
                <Link href="/dashboard/alerts" className="glass-card rounded-3xl p-5 flex flex-col justify-between h-40 group relative overflow-hidden border border-[#C8A557]/20">
                  ...
                  <div className="flex items-start justify-between mb-2">
                    <span className="material-symbols-outlined text-3xl text-[#C8A557]">notifications_active</span>
                    <span className="text-[9px] font-bold px-1.5 py-0.5 bg-[#C8A557]/20 text-amber-300 rounded-full border border-[#C8A557]/30 animate-pulse">REAL-TIME</span>
                  </div>
              ...
              {(userRole === 'admin' || userRole === 'manufacturer' || userRole === 'importer') && (
                <Link href="/dashboard/integration" className="glass-card rounded-3xl p-5 flex flex-col justify-between h-40 group relative overflow-hidden border border-cyan-500/20">
                  <div className="absolute inset-0 bg-gradient-to-br from-cyan-400/15 to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />
                  <div className="flex items-start justify-between mb-2">
              ...
              {(userRole === 'manufacturer') && (
                <Link href="/dashboard/certificates" className="glass-card rounded-3xl p-5 flex flex-col justify-between h-40 group relative overflow-hidden border border-green-500/20">
                  <div className="absolute inset-0 bg-gradient-to-br from-green-400/15 to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />
                  <div className="flex items-start justify-between mb-2">
              ...
              {(userRole === 'admin' || userRole === 'consumer' || userRole === 'importer' || userRole === 'manufacturer') && (
                <Link href="/verify" className="glass-card rounded-3xl p-5 flex flex-col h-40 group border border-amber-300/30 bg-amber-900/20">
                  <div className="flex justify-between items-start mb-2">
                    ...
                    <div className="bg-gradient-to-b from-yellow-300 to-[#C8A557] rounded p-1 shadow-lg shadow-amber-500/50"><span className="material-symbols-outlined text-white text-md">star</span></div>
                  </div>
              ...
              {(userRole === 'admin' || userRole === 'consumer') && (
                <Link href="/dashboard/report" className="glass-card rounded-3xl p-5 flex flex-col justify-between h-40 group relative overflow-hidden border border-red-500/20">
                  ...
                  <div className="flex items-start justify-between mb-2">
                    ...
                    <span className="text-[9px] font-bold px-1.5 py-0.5 bg-red-500/20 text-red-300 rounded-full border border-red-500/30">ẨN DANH</span>
                  </div>
                  <div><p className="text-[10px] text-slate-300 border-b border-white/10 pb-1 mb-1">{userRole === 'admin' ? 'Xử lý báo cáo' : 'Báo cáo nghi vấn'}</p><h3 className="text-sm font-bold text-white">Báo cáo Hàng giả</h3></div>
                </Link>
              )}

              {/* ── Hậu kiểm: Admin only ── */}
              {(userRole === 'admin') && (
                <Link href="/dashboard/haukiem" className="glass-card rounded-3xl p-5 flex flex-col justify-between h-32 group relative overflow-hidden border border-blue-500/20">
                ...
                {logs.slice(0, 2).map((log, i) => (
                  <Link href="/dashboard/history" key={i} className="snap-start shrink-0 w-72 glass-card rounded-2xl overflow-hidden group cursor-pointer h-40 flex flex-col justify-end relative">
                    ...
                    <div className="relative z-20 p-4">
                      <span className={`px-2 py-1 ${log.status === 'success' ? 'bg-emerald-500' : log.status === 'warning' ? 'bg-[#C8A557]' : 'bg-red-600'} text-white text-[9px] font-black rounded mb-2 inline-block ${log.status === 'error' ? 'animate-pulse' : ''}`}>
          ...
          {/* ── RIGHT — Globe ── */}
          <div className="xl:col-span-6 relative flex flex-col justify-between h-full min-h-[420px] sm:min-h-[520px] xl:min-h-[640px]">
            {/* Header */}
            ...
            {/* Map buttons — positioned outside ZoomableGroup so they stay fixed */}
            <div className="absolute top-3 right-4 z-20 flex flex-col gap-2">

              <div className="glass-panel px-3 py-2 rounded-xl text-[10px] font-bold text-cyan-400 border-cyan-500/20 flex items-center justify-center gap-1 mb-1">
            ...
            {/* Bottom section — z-20 keeps it above the map canvas */}
            <div className="mt-auto relative z-20 flex justify-between items-end w-full pb-4 pointer-events-none">
              <div className="hidden sm:block w-72 xl:w-80 space-y-4 pt-12 pointer-events-auto">
                  ...
                  <div className="glass-panel rounded-2xl border border-white/10 overflow-hidden w-72">
                    ...
                    <div className="px-3 py-1.5 flex items-center justify-between border-b border-white/10">
                      ...
                      <div className="flex gap-1 items-center">
                        <span className={`text-[8px] font-bold px-1.5 py-0.5 rounded-full border ${ipInfo.source === 'gps' ? 'bg-emerald-500/20 text-emerald-400 border-emerald-500/30' : 'bg-[#C8A557]/20 text-[#C8A557] border-[#C8A557]/30'}`}>
                        ...
                        <button
                          ...
                          className={`transition ${gpsStatus === 'loading' ? 'animate-spin text-cyan-400' : 'text-slate-500 hover:text-white'}`} title="Làm mới vị trí">
                    ...
                    {ipInfo.lat && ipInfo.lon ? (
                      <div className="relative w-full h-36">
                        <iframe
                          ...
                          style={{ filter: 'hue-rotate(195deg) saturate(0.8) brightness(0.75)' }}
                        />
                      </div>
                    ) : (
                      <div className="h-20 flex items-center justify-center bg-white/5">
                        <span className="material-symbols-outlined text-3xl text-slate-600">map</span>
                      </div>
                    )}
                    ...
                    <div className="px-3 py-2 flex items-center gap-2">
                      <span className={`material-symbols-outlined text-[16px] ${ipInfo.source === 'gps' ? 'text-emerald-400' : 'text-[#C8A557]'}`}>
                        {ipInfo.source === 'gps' ? 'gps_fixed' : 'wifi_tethering'}
                      </span>
                      <div>
                        <p className="text-white font-black text-sm leading-tight">{ipInfo.city}</p>
                        {ipInfo.lat && ipInfo.lon && (
                          <p className="text-slate-400 text-[10px]">{Number(ipInfo.lat).toFixed(5)}, {Number(ipInfo.lon).toFixed(5)}</p>
                        )}
                      </div>
                    </div>
                  </div>
