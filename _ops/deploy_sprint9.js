...
const FILES = [
  'src/lib/lifecycleConfig.ts',
  'src/app/api/lifecycle-config/route.ts',
  'src/app/api/lifecycle-reports/route.ts',
...
async function main() {
  ...
  const backupDir = `${REMOTE_ROOT}/_backups/sprint9.${stamp}`;
