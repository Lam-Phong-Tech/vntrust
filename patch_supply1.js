...
`<button onClick={() => setChartPeriod("1")} className={\`\${chartPeriod === "1" ? "transparent-container text-primary" : "hover:transparent-container text-secondary"} px-4 py-2 rounded-lg text-xs font-bold transition-colors\`}>{t("sc_day")}</button>
                  <button onClick={() => setChartPeriod("7")} className={\`\${chartPeriod === "7" ? "transparent-container text-primary" : "hover:transparent-container text-secondary"} px-4 py-2 rounded-lg text-xs font-bold transition-colors\`}>{t("sc_week")}</button>
                  <button onClick={() => setChartPeriod("30")} className={\`\${chartPeriod === "30" ? "transparent-container text-primary" : "hover:transparent-container text-secondary"} px-4 py-2 rounded-lg text-xs font-bold transition-colors\`}>{t("sc_month")}</button>`);
