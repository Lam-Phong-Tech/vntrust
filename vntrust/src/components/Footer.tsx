    ...
    <footer className="w-full border-t border-slate-200/30 dark:border-slate-800/30 bg-slate-50 dark:bg-slate-950">
      <div className="flex flex-col md:flex-row justify-between items-center px-12 py-8 gap-4">
        ...
        <div className="flex flex-wrap justify-center gap-8">
          ...
          <a className="font-body text-xs uppercase tracking-widest text-slate-500 hover:text-[#6FB585] transition-opacity" href="#">{t("footer_link2")}</a>
          <a className="font-body text-xs uppercase tracking-widest text-slate-500 hover:text-[#6FB585] transition-opacity" href="#">{t("footer_link3")}</a>
          <a className="font-body text-xs uppercase tracking-widest text-slate-500 hover:text-[#6FB585] transition-opacity" href="#">{t("footer_link4")}</a>
        </div>
