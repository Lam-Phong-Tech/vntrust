...
export default function AppCarousel() {
  const apps = [
    { name: "Bảng điều khiển", icon: "dashboard", url: "/dashboard", color: "bg-[#C8A557]" },
    { name: "Quản lý Tài sản", icon: "inventory_2", url: "/dashboard/inventory", color: "bg-[#4A7C5C]" },
    { name: "Mã QR", icon: "qr_code_scanner", url: "/verify", color: "bg-[#C8A557]" },
    ...
    { name: "Bảo mật", icon: "verified_user", url: "/dashboard/security", color: "bg-[#C8A557]" },
    { name: "Báo cáo Mobile", icon: "monitoring", url: "#", color: "bg-[#C8A557]" },
