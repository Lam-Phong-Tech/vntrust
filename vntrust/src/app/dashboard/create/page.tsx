  ...
  return (
    <div className="min-h-[calc(100vh-80px)] w-full relative flex flex-col p-4 md:p-8 max-w-lg mx-auto">
      ...
      <div className="flex flex-col gap-4">
        {/* Thêm sản phẩm */}
        <Link href="/dashboard/inventory" className="glass-card rounded-3xl p-6 border border-[#C8A557]/20 flex items-center gap-5 group hover:bg-white/5 transition">
          <div className="w-14 h-14 rounded-2xl bg-[#C8A557]/20 flex items-center justify-center shrink-0 border border-[#C8A557]/30 group-hover:scale-105 transition-transform">
            <span className="material-symbols-outlined text-3xl text-[#C8A557]">inventory_2</span>
          </div>
          <div>
        ...
        {/* Tạo Lô hàng */}
        <Link href="/dashboard/warehouse" className="glass-card rounded-3xl p-6 border border-[#4A7C5C]/20 flex items-center gap-5 group hover:bg-white/5 transition">
          <div className="w-14 h-14 rounded-2xl bg-[#4A7C5C]/20 flex items-center justify-center shrink-0 border border-[#4A7C5C]/30 group-hover:scale-105 transition-transform">
            <span className="material-symbols-outlined text-3xl text-[#6FB585]">conveyor_belt</span>
          </div>
          <div>
