              ...
              <Link href="/dashboard/history" className="glass-card rounded-3xl p-5 flex flex-col justify-between h-32 group">
                ...
                <div className="glass-card rounded-3xl p-3 sm:p-4 flex flex-col justify-between h-32 bg-red-900/20 border-red-500/30 min-w-0 overflow-hidden">
                  <div className="flex gap-1.5 sm:gap-2 min-w-0">
                    ...
                    <a href="tel:1900" className="flex-1 min-w-0 bg-[#1F6FEB]/15 rounded-xl p-1.5 text-center border border-[#1F6FEB]/30 hover:bg-[#1F6FEB]/25 transition">
                      <p className="text-[8px] sm:text-[9px] font-bold text-blue-200 truncate leading-tight">{lang === 'en' ? 'SUPPORT' : 'HỖ TRỢ'}</p>
