...
const CAT_COLORS: Record<string, string> = {
  "Nghiệp vụ": "text-blue-300 bg-[#C8A557]/15 border-[#C8A557]/30",
  "Kỹ thuật":  "text-cyan-300 bg-[#C8A557]/15 border-[#C8A557]/30",
  "AI":        "text-purple-300 bg-[#C8A557]/15 border-[#C8A557]/30",
  "Bảo mật":   "text-red-300 bg-red-500/15 border-red-500/30",
  "Hải quan":  "text-amber-300 bg-[#C8A557]/15 border-[#C8A557]/30",
  "Actor":     "text-emerald-300 bg-[#4A7C5C]/15 border-[#4A7C5C]/30",
    ...
    <div className="min-h-[calc(100vh-80px)] p-6 md:p-10 max-w-5xl mx-auto">
      ...
      <div className="mb-8">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-black text-white font-display">Chú giải Thuật ngữ</h1>
