    ...
    <div className="min-h-[calc(100vh-80px)] w-full relative overflow-hidden flex flex-col p-6 md:p-12 xl:p-16 max-w-[1600px] mx-auto">
      ...
      <div className="relative z-10 w-full h-full flex flex-col gap-16 max-w-6xl mx-auto">
        ...
        <div className="bg-white/5 border border-white/10 rounded-[2.5rem] p-8 md:p-12 shadow-2xl backdrop-blur-md">
          <h2 className="text-2xl md:text-3xl font-black font-display text-white mb-10 flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-[#C8A557]/20 flex items-center justify-center"><span className="material-symbols-outlined text-[#C8A557]">verified</span></div>
        ...
        {/* Process */}
        <div className="mb-12">
          <h2 className="text-2xl md:text-3xl font-black font-display text-white mb-12 flex items-center justify-center gap-3">
            <span className="material-symbols-outlined text-[#C8A557] text-4xl">sync</span>
            {t("ent_process_title")}
          </h2>
          <div className="relative max-w-4xl mx-auto">
            <div className="absolute left-8 md:left-1/2 top-4 bottom-4 w-1 bg-gradient-to-b from-[#C8A557]/50 via-[#C8A557]/50 to-[#4A7C5C]/50 -translate-x-1/2 rounded-full"></div>
            <div className="flex flex-col gap-16 relative z-10">
              {[
                ...
                <div key={key} className="flex flex-col md:flex-row items-center gap-8">
                  ...
                  <div className={`w-20 h-20 rounded-full flex flex-col items-center justify-center shrink-0 relative z-10 group hover:scale-110 transition border-[3px] ${
                    color === "cyan"
                      ? "bg-[#0a2238] border-[#C8A557] shadow-[0_0_30px_rgba(34,211,238,0.5)]"
                      : color === "blue"
                      ? "bg-[#0a1f38] border-[#C8A557] shadow-[0_0_30px_rgba(59,130,246,0.5)]"
                      : "bg-[#082a1e] border-[#4A7C5C] shadow-[0_0_30px_rgba(52,211,153,0.5)]"
                  }`}>
                    <span className={`material-symbols-outlined text-3xl group-hover:animate-bounce ${
                      color === "cyan" ? "text-[#C8A557]" : color === "blue" ? "text-[#C8A557]" : "text-[#6FB585]"
                    }`}>{icon}</span>
                  </div>
