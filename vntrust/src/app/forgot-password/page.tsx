...
export default function ForgotPasswordPage() {
  ...
  return (
    <div className="forgot-password-page min-h-screen bg-[#0b1320] flex flex-col items-center justify-center px-3 py-5 sm:p-6 lg:px-8 lg:py-8 relative overflow-hidden overflow-x-hidden">
      {/* Background blobs */}
      ...
      {/* Card */}
      <div className="forgot-password-card bg-[#1a2235]/90 backdrop-blur-xl border border-slate-800/50 p-4 sm:p-6 rounded-2xl sm:rounded-3xl w-full max-w-[26rem] shadow-2xl z-10">
        {/* Header */}
