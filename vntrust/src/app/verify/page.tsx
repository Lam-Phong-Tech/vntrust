...
export default function VerifyPage() {
  ...
  return (
    <div className="verify-consumer-page verify-page-hub min-h-[calc(100vh-80px)] pb-12 flex items-center justify-center px-4 md:px-12 relative">
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        ...
        <div className="absolute top-[20%] right-[10%] w-[30%] h-[30%] rounded-full bg-[#C8A557]/5 blur-[120px]"></div>
      </div>
      <div className="max-w-6xl w-full grid grid-cols-1 md:grid-cols-12 gap-8 relative z-10">
        <header className="md:col-span-12 text-center mb-8">
          ...
          <h1 className="text-4xl md:text-6xl font-black font-display text-on-surface tracking-tighter mb-4">{t("verify_title")}</h1>
        ...
        <div className="md:col-span-12 grid grid-cols-1 md:grid-cols-3 gap-6">
          <Link href="/verify/scan" className="group flex flex-col h-full bg-surface-container-lowest/50 backdrop-blur-xl border border-outline-variant/20 hover:border-primary/50 hover:bg-surface-container-lowest transition-all hover:-translate-y-2 rounded-3xl p-8 overflow-hidden relative shadow-lg">
            ...
            <h3 className="text-2xl font-black font-display mb-3 text-on-surface">{t("verify_card1_title")}</h3>
          ...
          <Link href="/verify/manual" className="group flex flex-col h-full bg-surface-container-lowest/50 backdrop-blur-xl border border-outline-variant/20 hover:border-tertiary/50 hover:bg-surface-container-lowest transition-all hover:-translate-y-2 rounded-3xl p-8 overflow-hidden relative shadow-lg">
            ...
            <h3 className="text-2xl font-black font-display mb-3 text-on-surface">{t("verify_card2_title")}</h3>
          ...
          <Link href="/verify/ai-doc" className="group flex flex-col h-full bg-surface-container-lowest/50 backdrop-blur-xl border border-outline-variant/20 hover:border-[#C8A557]/50 hover:bg-surface-container-lowest transition-all hover:-translate-y-2 rounded-3xl p-8 overflow-hidden relative shadow-lg">
            ...
            <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-[#C8A557] to-transparent opacity-0 group-hover:opacity-100 transition-opacity"></div>
            <div className="w-16 h-16 rounded-2xl bg-[#C8A557]/10 flex items-center justify-center text-[#C8A557] mb-6 transition-transform group-hover:scale-110">
              <span className="material-symbols-outlined text-3xl">document_scanner</span>
            </div>
            <h3 className="text-2xl font-black font-display mb-3 text-on-surface">{t("verify_card3_title")}</h3>
            <p className="text-on-surface-variant text-sm mb-8 flex-1">{t("verify_card3_desc")}</p>
            <div className="flex items-center gap-2 text-[#C8A557] font-bold text-xs uppercase tracking-widest mt-auto">
        ...
        <div className="md:col-span-12 flex flex-wrap justify-center gap-x-10 gap-y-4 mt-8 opacity-60">
          <div className="flex items-center gap-2"><span className="material-symbols-outlined text-lg">verified</span><span className="font-display text-xs font-bold uppercase tracking-widest">ISO 27001 Certified</span></div>
          <div className="flex items-center gap-2"><span className="material-symbols-outlined text-lg">hub</span><span className="font-display text-xs font-bold uppercase tracking-widest">Ethereum Mainnet</span></div>
          <div className="flex items-center gap-2"><span className="material-symbols-outlined text-lg">api</span><span className="font-display text-xs font-bold uppercase tracking-widest">AI Vision Processing</span></div>
        </div>
      </div>
    </div>
  );
