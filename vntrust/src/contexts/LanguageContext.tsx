...
const dict: Record<string, Record<string, string>> = {
  ...
  verify_sub: { vi: "Chọn phương thức phù hợp để bắt đầu quy trình kiểm định. Mọi dữ liệu đều được ánh xạ lên AI VeriGoods.", en: "Choose the appropriate method to begin the verification process. All data is mapped to AI VeriGoods.", zh: "选择合适的方式开始验证流程。所有数据均映射到 AI VeriGoods。", ja: "検証プロセスを開始する適切な方法を選択してください。", ko: "검증 프로세스를 시작하기 위해 적절한 방법을 선택하세요.", fr: "Choisissez la méthode appropriée pour commencer le processus de vérification." },
