...
const dict: Record<string, Record<string, string>> = {
  ...
  search_sub: { vi: "Trợ lý AI AI VeriGoods...", en: "AI VeriGoods AI Assistant...", zh: "AI VeriGoods AI助手...", ja: "AI VeriGoods AIアシスタント...", ko: "AI VeriGoods AI 어시스턴트...", fr: "Assistant IA AI VeriGoods..." },
  ...
  verify_sub: { vi: "Chọn phương thức phù hợp để bắt đầu quy trình kiểm định. Mọi dữ liệu đều được ánh xạ lên Sổ cái Bất biến Blockchain AI VeriGoods.", en: "Choose the appropriate method to begin the verification process. All data is mapped to the AI VeriGoods Immutable Blockchain Ledger.", zh: "选择合适的方式开始验证流程。所有数据均映射到AI VeriGoods不可变区块链账本。", ja: "検証プロセスを開始する適切な方法を選択してください。", ko: "검증 프로세스를 시작하기 위해 적절한 방법을 선택하세요.", fr: "Choisissez la méthode appropriée pour commencer le processus de vérification." },
  ...
  ent_s1_desc: { vi: "Sản phẩm ở nhà máy được gắn mã QR AI VeriGoods công nghệ nén mật mã trước khi đóng thùng và xuất xưởng ra thị trường.", en: "Products at the factory are tagged with AI VeriGoods QR codes using encryption technology before packaging and market release.", zh: "工厂产品在包装出厂前贴附采用加密技术的AI VeriGoods QR码。", ja: "工場の製品は梱包前に暗号化QRコードでタグ付けされます。", ko: "공장의 제품은 포장 전에 암호화 QR 코드로 태깅됩니다.", fr: "Les produits sont étiquetés avec des codes QR AI VeriGoods avant l'emballage." },
  ...
  nav_chat_placeholder: { vi: "Hỏi AI VeriGoods AI...", en: "Ask AI VeriGoods AI...", zh: "询问 AI VeriGoods AI...", ja: "AI VeriGoods AI に質問...", ko: "AI VeriGoods AI에게 질문하세요...", fr: "Demandez à l'IA AI VeriGoods..." },
  ...
  aidoc_ready: { vi: "Sẵn sàng để chạy mô hình AI AI VeriGoods...", en: "Ready to run AI VeriGoods AI model...", zh: "准备运行AI VeriGoods AI模型...", ja: "AI VeriGoods AIモデルを実行する準備ができました...", ko: "AI VeriGoods AI 모델을 실행할 준비가 되었습니다...", fr: "Prêt à exécuter le modèle IA AI VeriGoods..." },
  ...
  // ── Chat missing ──
  chat_greeting: { vi: "Chào bạn! 👋 Mình là AI AI VeriGoods, sẵn sàng giúp bạn:\n• Tra cứu sản phẩm theo số serial\n• Kiểm tra lô hàng & chuỗi cung ứng\n• Hướng dẫn sử dụng hệ thống\n• Hỗ trợ kỹ thuật 24/7\n\nBạn cần giúp gì hôm nay? 😊", en: "Hello! 👋 I am AI VeriGoods AI, ready to help you:\n• Lookup products by serial number\n• Check batches & supply chain\n• System usage guide\n• 24/7 technical support\n\nHow can I help you today? 😊", zh: "你好！👋我是 AI VeriGoods AI，随时准备为您提供帮助：\n•按序列号查找产品\n•检查批次和供应链\n•系统使用指南\n• 24/7技术支持\n\n今天我能帮您什么？😊", ja: "こんにちは！👋 AI VeriGoods AIです。次のサポートを提供します：\n•シリアル番号で製品を検索\n•バッチとサプライチェーンを確認\n•システム使用ガイド\n•24時間年中無休の技術サポート\n\n今日はどのようにお手伝いしましょうか？😊", ko: "안녕하세요! 👋 AI VeriGoods AI입니다. 다음을 도와드릴 수 있습니다:\n•시리얼 번호로 제품 조회\n•배치 및 공급망 확인\n•시스템 사용 가이드\n•24/7 기술 지원\n\n오늘 무엇을 도와드릴까요? 😊", fr: "Bonjour! 👋 Je suis l'IA AI VeriGoods, prêt à vous aider:\n• Recherche de produits par numéro de série\n• Vérifier les lots & la chaîne d'approvisionnement\n• Guide d'utilisation du système\n• Support technique 24/7\n\nComment puis-je vous aider aujourd'hui? 😊" },
  ...
  ser_desc: { vi: "Nhập chuỗi định danh duy nhất (UUID/Serial) in chìm dưới lớp phủ tem AI VeriGoods chống giả.", en: "Enter the unique identification string (UUID/Serial) hidden under the AI VeriGoods anti-counterfeiting stamp layer.", zh: "输入隐藏在AI VeriGoods防伪标志层下的唯一标识字符串（UUID/Serial）。", ja: "AI VeriGoods偽造防止スタンプ層の下に隠されている一意の識別文字列（UUID /シリアル）を入力します。", ko: "AI VeriGoods 위조 방지 스탬프 층 아래에 숨겨진 고유 식별 문자열(UUID/Serial)을 입력하세요.", fr: "Saisissez la chaîne d'identification unique (UUID/Série) cachée sous la couche du cachet anti-contrefaçon AI VeriGoods." },
  ...
  ser_enc_desc: { vi: "Giao dịch truy vấn của bạn được mã hóa hoàn toàn. AI VeriGoods ẩn danh địa chỉ mạng để đảm bảo tính riêng tư trong đối soát.", en: "Your query transaction is fully encrypted. AI VeriGoods anonymizes network addresses to ensure privacy during cross-checking.", zh: "您的查询交易已完全加密。 AI VeriGoods对网络地址进行匿名处理，以确保在交叉核对期间保护隐私。", ja: "クエリトランザクションは完全に暗号化されます。 AI VeriGoodsは、クロスチェック中にプライバシーを確​​保するためにネットワークアドレスを匿名化します。", ko: "쿼리 트랜잭션은 완전히 암호화됩니다. AI VeriGoods는 교차 확인 중에 개인 정보를 보장하기 위해 네트워크 주소를 익명화합니다.", fr: "Votre transaction de requête est entièrement cryptée. AI VeriGoods anonymise les adresses réseau pour garantir la confidentialité." },

  // ── QR Scan ──
  qr_title: { vi: "Quét Mã Bảo Mật", en: "Scan Security Code", zh: "扫描安全码", ja: "セキュリティコードをスキャン", ko: "보안 코드 스캔", fr: "Scanner le code de sécurité" },
  qr_desc: { vi: "Hướng camera thiết bị vào mã QR hoặc Mã Vạch trên tem chống giả AI VeriGoods. Hệ thống sẽ tự động nhận diện.", en: "Point your device camera at the QR code or Barcode on the AI VeriGoods anti-counterfeit stamp. The system will auto-detect.", zh: "将设备相机对准AI VeriGoods防伪标签上的QR码或条形码。系统将自动检测。", ja: "デバイスカメラをAI VeriGoods偽造防止スタンプのQRコードまたはバーコードに向けます。システムが自動検出します。", ko: "기기 카메라를 AI VeriGoods 위조 방지 스탬프의 QR 코드 또는 바코드로 향하세요. 시스템이 자동으로 감지합니다.", fr: "Pointez l'appareil photo vers le code QR ou le code-barres sur le tampon anti-contrefaçon. Le système détectera automatiquement." },
  ...
  vuid_14: { vi: "Sản phẩm đã được xác thực thành công qua Sổ cái Bất biến AI VeriGoods. Nguồn gốc 100%.", en: "Product verified via AI VeriGoods Immutable Ledger. Origin confirmed 100%.", zh: "产品已通过AI VeriGoods不可变账本验证。来源100%确认。", ja: "AI VeriGoods不変台帳で製品が検証されました。原産地100%確認済み。", ko: "AI VeriGoods 불변 원장을 통해 제품이 검증되었습니다. 원산지 100% 확인됨.", fr: "Produit vérifié via le registre AI VeriGoods. Origine confirmée à 100%." },
  ...
  // ── AI Shared Responses ──
  ai_resp_0: { vi: `Chào bạn! 😊 Rất vui được gặp bạn hôm nay. Mình là AI của AI VeriGoods nha — bạn cần tra serial, kiểm tra lô hàng, hay hỏi gì khác không?`, en: `Chào bạn! 😊 Rất vui được gặp bạn hôm nay. Mình là AI của AI VeriGoods nha — bạn cần tra serial, kiểm tra lô hàng, hay hỏi gì khác không?`, zh: `Chào bạn! 😊 Rất vui được gặp bạn hôm nay. Mình là AI của AI VeriGoods nha — bạn cần tra serial, kiểm tra lô hàng, hay hỏi gì khác không?`, ja: `Chào bạn! 😊 Rất vui được gặp bạn hôm nay. Mình là AI của AI VeriGoods nha — bạn cần tra serial, kiểm tra lô hàng, hay hỏi gì khác không?`, ko: `Chào bạn! 😊 Rất vui được gặp bạn hôm nay. Mình là AI của AI VeriGoods nha — bạn cần tra serial, kiểm tra lô hàng, hay hỏi gì khác không?`, fr: `Chào bạn! 😊 Rất vui được gặp bạn hôm nay. Mình là AI của AI VeriGoods nha — bạn cần tra serial, kiểm tra lô hàng, hay hỏi gì khác không?` },
  ...
  ai_resp_9: { vi: `Chuỗi cung ứng AI VeriGoods theo dõi **4,821 điểm** trên toàn quốc 🗺️\nVào **Chuỗi Cung ứng** trên menu để xem bản đồ realtime nhé!`, en: `Chuỗi cung ứng AI VeriGoods theo dõi **4,821 điểm** trên toàn quốc 🗺️\nVào **Chuỗi Cung ứng** trên menu để xem bản đồ realtime nhé!`, zh: `Chuỗi cung ứng AI VeriGoods theo dõi **4,821 điểm** trên toàn quốc 🗺️\nVào **Chuỗi Cung ứng** trên menu để xem bản đồ realtime nhé!`, ja: `Chuỗi cung ứng AI VeriGoods theo dõi **4,821 điểm** trên toàn quốc 🗺️\nVào **Chuỗi Cung ứng** trên menu để xem bản đồ realtime nhé!`, ko: `Chuỗi cung ứng AI VeriGoods theo dõi **4,821 điểm** trên toàn quốc 🗺️\nVào **Chuỗi Cung ứng** trên menu để xem bản đồ realtime nhé!`, fr: `Chuỗi cung ứng AI VeriGoods theo dõi **4,821 điểm** trên toàn quốc 🗺️\nVào **Chuỗi Cung ứng** trên menu để xem bản đồ realtime nhé!` },
  ai_resp_10: { vi: `Bảo mật là ưu tiên số 1 của AI VeriGoods đó! 🔐\n• Mã hóa AES-256 toàn bộ data\n• 2FA bắt buộc cho doanh nghiệp\n• AI giám sát 24/7 < 10 giây`, en: `Bảo mật là ưu tiên số 1 của AI VeriGoods đó! 🔐\n• Mã hóa AES-256 toàn bộ data\n• 2FA bắt buộc cho doanh nghiệp\n• AI giám sát 24/7 < 10 giây`, zh: `Bảo mật là ưu tiên số 1 của AI VeriGoods đó! 🔐\n• Mã hóa AES-256 toàn bộ data\n• 2FA bắt buộc cho doanh nghiệp\n• AI giám sát 24/7 < 10 giây`, ja: `Bảo mật là ưu tiên số 1 của AI VeriGoods đó! 🔐\n• Mã hóa AES-256 toàn bộ data\n• 2FA bắt buộc cho doanh nghiệp\n• AI giám sát 24/7 < 10 giây`, ko: `Bảo mật là ưu tiên số 1 của AI VeriGoods đó! 🔐\n• Mã hóa AES-256 toàn bộ data\n• 2FA bắt buộc cho doanh nghiệp\n• AI giám sát 24/7 < 10 giây`, fr: `Bảo mật là ưu tiên số 1 của AI VeriGoods đó! 🔐\n• Mã hóa AES-256 toàn bộ data\n• 2FA bắt buộc cho doanh nghiệp\n• AI giám sát 24/7 < 10 giây` },
  ai_resp_11: { vi: `App AI VeriGoods Mobile xịn lắm đó! 📱\n• Quét QR bằng camera mà không cần nhập tay\n• Offline mode khi mất mạng\n\nBấm **APP DOWNLOAD** trên thanh trên để tải!`, en: `App AI VeriGoods Mobile xịn lắm đó! 📱\n• Quét QR bằng camera mà không cần nhập tay\n• Offline mode khi mất mạng\n\nBấm **APP DOWNLOAD** trên thanh trên để tải!`, zh: `App AI VeriGoods Mobile xịn lắm đó! 📱\n• Quét QR bằng camera mà không cần nhập tay\n• Offline mode khi mất mạng\n\nBấm **APP DOWNLOAD** trên thanh trên để tải!`, ja: `App AI VeriGoods Mobile xịn lắm đó! 📱\n• Quét QR bằng camera mà không cần nhập tay\n• Offline mode khi mất mạng\n\nBấm **APP DOWNLOAD** trên thanh trên để tải!`, ko: `App AI VeriGoods Mobile xịn lắm đó! 📱\n• Quét QR bằng camera mà không cần nhập tay\n• Offline mode khi mất mạng\n\nBấm **APP DOWNLOAD** trên thanh trên để tải!`, fr: `App AI VeriGoods Mobile xịn lắm đó! 📱\n• Quét QR bằng camera mà không cần nhập tay\n• Offline mode khi mất mạng\n\nBấm **APP DOWNLOAD** trên thanh trên để tải!` },
  ...
  vman_2: { vi: "Nhập chuỗi định danh duy nhất (UUID/Serial) in chìm dưới lớp phủ tem AI VeriGoods chống giả.", en: "Enter the unique identification string (UUID/Serial) on the AI VeriGoods anti-counterfeit stamp.", zh: "输入AI VeriGoods防伪标签上的唯一标识字符串（UUID/Serial）。", ja: "AI VeriGoods偽造防止スタンプの一意識別文字列を入力してください。", ko: "AI VeriGoods 위조 방지 스탬프의 고유 식별 문자열을 입력하세요.", fr: "Entrez la chaîne d'identification unique sur le tampon AI VeriGoods." },
  ...
  mob_nav_supply_short: { vi: "Chuỗi CƯ", en: "Supply",   zh: "供应链", ja: "サプライ",   ko: "공급망", fr: "Chaîne"     },
  // ── Supply Chain page additions ─────────────────────────────────
  sc_no_data:       { vi: "Chưa có dữ liệu quét", en: "No scan data yet", zh: "暂无扫描数据", ja: "スキャンデータなし", ko: "스캔 데이터 없음", fr: "Aucune donnée de scan" },
  sc_scans_count:   { vi: "lượt xác thực", en: "verifications", zh: "次验证", ja: "認証回数", ko: "인증 횟수", fr: "vérifications" },
  // ── Legal Compliance page ─────────────────────────────────────
  comp_legal_link:  { vi: "Tuân thủ Pháp lý", en: "Legal Compliance", zh: "法律合规", ja: "法的コンプライアンス", ko: "법적 준수", fr: "Conformité légale" },
  mob_nav_kyc:      { vi: "Duyệt KYC",  en: "KYC",       zh: "审核",   ja: "KYC",        ko: "KYC",    fr: "KYC"        },
