      ...
      <div className="w-full max-w-2xl relative z-10 flex flex-col items-center">
        ...
        <div className="glass-panel border border-outline-variant/15 rounded-3xl p-8 md:p-12 w-full shadow-2xl flex flex-col text-center bg-surface-container-lowest/80 backdrop-blur-xl">
          ...
          <form onSubmit={handleVerify} className="space-y-8 w-full max-w-md mx-auto">
            ...
            <Link href="/verify/scan" className="w-full max-w-md mx-auto bg-surface-container-high text-on-surface border border-outline-variant/30 py-4 rounded-2xl font-bold font-headline tracking-wide uppercase hover:bg-surface-container-highest active:scale-[0.98] transition-all flex justify-center items-center gap-2">
