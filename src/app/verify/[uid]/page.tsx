...
export default function VerificationResult() {
  ...
  // ── Outer container: dark bg on all screens, centres the card on desktop ──
  const outerCls =
    "min-h-screen w-full bg-[#050B14] flex items-start justify-center md:pt-10 md:pb-10 lg:items-stretch lg:pt-0 lg:pb-0 lg:h-[calc(100vh-80px)] lg:min-h-[calc(100vh-80px)] lg:max-h-[calc(100vh-80px)] lg:overflow-hidden";
        ...
        <div className="s-result-wrapper desktop-responsive">
          <section className="s-fake">
            ...
            <div className="s-fake-top">
              <button className="s-auth-top-btn" onClick={() => router.push('/dashboard')}>
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                  <path d="M19 12H5M12 19l-7-7 7-7" />
                </svg>
              </button>
