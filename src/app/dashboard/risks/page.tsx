...
const CONSTRAINT_STATUS: Record<string, { cls: string; label: string; icon: string }> = {
  ...
  in_progress: { cls: "text-amber-300 bg-amber-500/15 border-amber-500/30",       label: "Đang xử lý",  icon: "autorenew" },
    ...
    <div className="min-h-[calc(100vh-80px)] p-6 md:p-10 max-w-7xl mx-auto">
      ...
      <div className="mb-8">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-black text-white font-headline">Giả định · Ràng buộc · Rủi ro</h1>
      ...
      <div className="grid grid-cols-4 gap-3 mb-8">
        {[
          ...
          { label: "Risk Score TB",      value: avgScore,       color: avgScore >= 6 ? "text-red-400" : avgScore >= 4 ? "text-amber-400" : "text-emerald-400", icon: "speed" },
          ...
          <div className="glass-panel border border-red-500/20 rounded-2xl p-5">
            ...
            <div className="grid grid-cols-3 gap-2">
              {[
                ...
                { label: "Medium/Low (≤5)", risks: RISKS.filter(r => r.score < 6), cls: "border-amber-500/30 bg-amber-500/10" },
              ].map((cell, i) => (
