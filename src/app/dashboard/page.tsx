        ...
        <div className="grid grid-cols-1 xl:grid-cols-12 gap-8 lg:gap-12 relative z-10 w-full h-full flex-1">
          ...
          <div className="xl:col-span-6 flex flex-col gap-6">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
              ...
              {(userRole === 'admin') && (
                <Link href="/dashboard/kyc" className="glass-card rounded-3xl p-5 flex flex-col justify-between h-40 group relative overflow-hidden border border-cyan-500/20">
                  ...
                  <div className="flex items-start justify-between mb-2">
                    ...
                    <span className="text-[9px] font-bold px-1.5 py-0.5 bg-amber-500/20 text-amber-300 rounded-full border border-amber-500/30">ADMIN</span>
                  </div>
                  <div>
              ...
              {userRole === 'admin' && (
                <Link href="/dashboard/alerts" className="glass-card rounded-3xl p-5 flex flex-col justify-between h-40 group relative overflow-hidden border border-amber-500/20">
                  ...
                  <div className="flex items-start justify-between mb-2">
                    <span className="material-symbols-outlined text-3xl text-amber-400">notifications_active</span>
                    <span className="text-[9px] font-bold px-1.5 py-0.5 bg-amber-500/20 text-amber-300 rounded-full border border-amber-500/30 animate-pulse">REAL-TIME</span>
                  </div>
                ...
                {ipInfo && (
                  <div className="glass-panel rounded-2xl border border-white/10 overflow-hidden w-72">
                    ...
                    <div className="px-3 py-2 flex items-center gap-2">
                      <span className={`material-symbols-outlined text-[16px] ${ipInfo.source === 'gps' ? 'text-emerald-400' : 'text-amber-400'}`}>
