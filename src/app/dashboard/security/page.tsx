          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="glass-panel border border-amber-500/20 rounded-2xl p-5">
                  ...
                  <div className="space-y-2">
                    {health.recentWarnings.map(w => (
                      <div key={w.id} className="flex items-center gap-3 p-3 bg-amber-500/10 border border-amber-500/20 rounded-xl text-sm hover:bg-amber-500/20 transition">
                        <span className="material-symbols-outlined text-amber-400 text-[16px] shrink-0">warning</span>
                        <div className="flex-1">
            ...
            <div className="space-y-6">
              {health.openAlertsList && health.openAlertsList.length > 0 && (
                <div className="glass-panel border border-violet-500/20 rounded-2xl p-5 h-full">
                  <div className="flex justify-between items-center mb-4">
                    <h2 className="text-sm font-bold text-white flex items-center gap-2">
                      <span className="material-symbols-outlined text-violet-400 text-[18px]">notifications_active</span>
