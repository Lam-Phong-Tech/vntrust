  ...
  return (
    <div className="min-h-[calc(100vh-80px)] w-full relative flex flex-col p-4 md:p-8 max-w-lg mx-auto">
      <div className="flex items-center gap-4 mb-8">
        ...
        <h1 className="text-xl font-bold text-white font-headline">Tạo mới</h1>
      </div>
      ...
      <div className="flex flex-col gap-4">
        ...
        {/* Báo cáo nội bộ */}
        <button onClick={() => alert('Tính năng đang được phát triển')} className="glass-card rounded-3xl p-6 border border-amber-500/20 flex items-center gap-5 group text-left w-full cursor-pointer hover:bg-white/5 transition">
          <div className="w-14 h-14 rounded-2xl bg-amber-500/20 flex items-center justify-center shrink-0 border border-amber-500/30 group-hover:scale-105 transition-transform">
            <span className="material-symbols-outlined text-3xl text-amber-400">campaign</span>
          </div>
          <div>
