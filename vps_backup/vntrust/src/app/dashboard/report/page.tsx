                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div>
                    <label className="text-xs font-bold text-slate-400 uppercase tracking-wider block mb-2">
                      Mã Serial / UID sản phẩm <span className="text-slate-600">(không bắt buộc)</span>
                    </label>
                    <input
                      value={form.serial}
            ...
            {loadingReports ? (
              ...
              <div className="space-y-3">
                {reports.map(r => {
                  ...
                  return (
                    <div key={r.id} className="glass-panel border border-white/10 rounded-2xl p-5 hover:border-white/20 transition">
                      <div className="flex flex-col md:flex-row md:items-start justify-between gap-4">
                        <div className="flex-1">
                          ...
                          <p className="text-sm text-slate-200 leading-relaxed">{r.moTa}</p>
                        </div>
                        {userRole === "admin" && (
