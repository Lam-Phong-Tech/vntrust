      ...
      <div className="w-full max-w-sm rounded-3xl p-6 shadow-2xl border border-white/10"
        ...
        <div className="flex items-center gap-3 mb-4">
          <div className="w-12 h-12 rounded-2xl bg-cyan-500/20 border border-cyan-500/30 flex items-center justify-center">
            <span className="material-symbols-outlined text-cyan-400 text-2xl" style={{ fontVariationSettings: "'FILL' 1" }}>
              location_on
            </span>
          </div>
          <div>
        ...
        <div className="flex gap-3">
          ...
          <button
            onClick={handleAllow}
            className="flex-1 py-3 bg-cyan-500 hover:bg-cyan-400 rounded-2xl text-sm font-bold text-white transition flex items-center justify-center gap-2"
          >
